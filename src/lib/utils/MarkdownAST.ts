...
export type MentionUserNode     = { type: 'mention_user';     id: number };
export type MentionEveryoneNode = { type: 'mention_everyone'; subtype: 'everyone' | 'here' };
export type MentionRoleNode     = { type: 'mention_role';     id: number };
export type MentionChannelNode  = { type: 'mention_channel';  id: number };
export type MentionServerNode   = { type: 'mention_server';   id: number };
